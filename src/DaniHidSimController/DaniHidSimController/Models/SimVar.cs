...
namespace DaniSimController.Models
{
    public sealed class SimVar
    {
        ...
        public static readonly SimVar VelocityBodyZ = new SimVar("VELOCITY BODY Z", "Velocity Body Z", SimVarType.FeetPerSecond);
        public static readonly SimVar VelocityBodyX = new SimVar("VELOCITY BODY X", "Velocity Body X", SimVarType.FeetPerSecond);
        public static readonly SimVar VelocityBodyY = new SimVar("VELOCITY BODY Y", "Velocity Body Y", SimVarType.FeetPerSecond);
        public static readonly SimVar VelocityWorldZ = new SimVar("VELOCITY WORLD Z", "Velocity World Z", SimVarType.FeetPerSecond);
        public static readonly SimVar VelocityWorldX = new SimVar("VELOCITY WORLD X", "Velocity World X", SimVarType.FeetPerSecond);
        public static readonly SimVar VelocityWorldY = new SimVar("VELOCITY WORLD Y", "Velocity World Y", SimVarType.FeetPerSecond);
        public static readonly SimVar AccelerationWorldX = new SimVar("ACCELERATION WORLD X", "Acceleration World X", SimVarType.FeetPerSecondSquared);
        public static readonly SimVar AccelerationWorldY = new SimVar("ACCELERATION WORLD Y", "Acceleration World Y", SimVarType.FeetPerSecondSquared);
        public static readonly SimVar AccelerationWorldZ = new SimVar("ACCELERATION WORLD Z", "Acceleration World Z", SimVarType.FeetPerSecondSquared);
        public static readonly SimVar AccelerationBodyX = new SimVar("ACCELERATION BODY X", "Acceleration Body X", SimVarType.FeetPerSecondSquared);
        public static readonly SimVar AccelerationBodyY = new SimVar("ACCELERATION BODY Y", "Acceleration Body Y", SimVarType.FeetPerSecondSquared);
        public static readonly SimVar AccelerationBodyZ = new SimVar("ACCELERATION BODY Z", "Acceleration Body Z", SimVarType.FeetPerSecondSquared);
        public static readonly SimVar RotationVelocityBodyX = new SimVar("ROTATION VELOCITY BODY X", "Rotation Velocity Body X", SimVarType.FeetPerSecond);
        public static readonly SimVar RotationVelocityBodyY = new SimVar("ROTATION VELOCITY BODY Y", "Rotation Velocity Body Y", SimVarType.FeetPerSecond);
        public static readonly SimVar RotationVelocityBodyZ = new SimVar("ROTATION VELOCITY BODY Z", "Rotation Velocity Body Z", SimVarType.FeetPerSecond);
        public static readonly SimVar RelativeWindVelocityBodyX = new SimVar("RELATIVE WIND VELOCITY BODY X", "Relative Wind Velocity Body X", SimVarType.FeetPerSecond);
        public static readonly SimVar RelativeWindVelocityBodyY = new SimVar("RELATIVE WIND VELOCITY BODY Y", "Relative Wind Velocity Body Y", SimVarType.FeetPerSecond);
        public static readonly SimVar RelativeWindVelocityBodyZ = new SimVar("RELATIVE WIND VELOCITY BODY Z", "Relative Wind Velocity Body Z", SimVarType.FeetPerSecond);
        ...
        public static readonly SimVar YokeYPosition = new SimVar("YOKE Y POSITION", "Yoke Y Position", SimVarType.Position);
        public static readonly SimVar YokeXPosition = new SimVar("YOKE X POSITION", "Yoke X Position", SimVarType.Position);
        ...
        public static readonly SimVar CenterWheelRpm = new SimVar("CENTER WHEEL RPM", "Center Wheel Rpm", SimVarType.Rpm);
        public static readonly SimVar LeftWheelRpm = new SimVar("LEFT WHEEL RPM", "Left Wheel Rpm", SimVarType.Rpm);
        public static readonly SimVar RightWheelRpm = new SimVar("RIGHT WHEEL RPM", "Right Wheel Rpm", SimVarType.Rpm);
        ...
        public static readonly SimVar WheelRpm = new SimVar("WHEEL RPM", "Wheel Rpm", SimVarType.Rpm);
        public static readonly SimVar AuxWheelRpm = new SimVar("AUX WHEEL RPM", "Aux Wheel Rpm", SimVarType.Rpm);
        public static readonly SimVar WheelRotationAngle = new SimVar("WHEEL ROTATION ANGLE", "Wheel Rotation Angle", SimVarType.Radians);
        public static readonly SimVar CenterWheelRotationAngle = new SimVar("CENTER WHEEL ROTATION ANGLE", "Center Wheel Rotation Angle", SimVarType.Radians);
        public static readonly SimVar LeftWheelRotationAngle = new SimVar("LEFT WHEEL ROTATION ANGLE", "Left Wheel Rotation Angle", SimVarType.Radians);
        public static readonly SimVar RightWheelRotationAngle = new SimVar("RIGHT WHEEL ROTATION ANGLE", "Right Wheel Rotation Angle", SimVarType.Radians);
        public static readonly SimVar AuxWheelRotationAngle = new SimVar("AUX WHEEL ROTATION ANGLE", "Aux Wheel Rotation Angle", SimVarType.Radians);
        ...
        public static readonly SimVar AmbientWindX = new SimVar("AMBIENT WIND X", "Ambient Wind X", SimVarType.MetersPerSecond);
        public static readonly SimVar AmbientWindY = new SimVar("AMBIENT WIND Y", "Ambient Wind Y", SimVarType.MetersPerSecond);
        public static readonly SimVar AmbientWindZ = new SimVar("AMBIENT WIND Z", "Ambient Wind Z", SimVarType.MetersPerSecond);
        public static readonly SimVar AmbientPrecipState = new SimVar("AMBIENT PRECIP STATE", "Ambient Precip State", SimVarType.Mask);
        public static readonly SimVar AircraftWindX = new SimVar("AIRCRAFT WIND X", "Aircraft Wind X", SimVarType.Knots);
        public static readonly SimVar AircraftWindY = new SimVar("AIRCRAFT WIND Y", "Aircraft Wind Y", SimVarType.Knots);
        public static readonly SimVar AircraftWindZ = new SimVar("AIRCRAFT WIND Z", "Aircraft Wind Z", SimVarType.Knots);
        ...
        public static readonly SimVar YokeYIndicator = new SimVar("YOKE Y INDICATOR", "Yoke Y Indicator", SimVarType.Position);
        public static readonly SimVar YokeXIndicator = new SimVar("YOKE X INDICATOR", "Yoke X Indicator", SimVarType.Position);
        ...
        public static readonly SimVar SemibodyLoadfactorY = new SimVar("SEMIBODY LOADFACTOR Y", "Semibody Loadfactor Y", SimVarType.Number);
